...
local b1a = tostring(settings.get("bank.option.1"))
...
local b2a = tostring(settings.get("bank.option.2"))
...
local b3a = tostring(settings.get("bank.option.3"))

local ontxt = "on"
local offtxt = "off"

term.clear()
paintutils.drawFilledBox(1, 1, 51, 18, colors.gray)
...
function b1f()
    ...
    term.write(b1txt)
    b1a = "false"
    settings.set("bank.option.1", false)
    settings.save()
end
...
function b1t()
    ...
    term.write(b1txt)
    b1a = "true"
    settings.set("bank.option.1", true)
    settings.save()
end
...
function b2f()
    ...
    term.write(b2txt)
    b2a = "false"
    settings.set("bank.option.2", false)
    settings.save()
end
...
function b2t()
    ...
    term.write(b2txt)
    b2a = "true"
    settings.set("bank.option.2", true)
    settings.save()
end
...
function b3f()
    ...
    term.write(b3txt)
    b3a = "false"
    settings.set("bank.option.3", false)
    settings.save()
end
...
function b3t()
    ...
    term.write(b3txt)
    b3a = "true"
    settings.set("bank.option.3", true)
    settings.save()
end
